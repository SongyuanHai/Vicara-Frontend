				...
				"vicaraapp.vicaraApp",
				{
					...
					validation : function(oEvt) {
						...
						var oInputName = sap.ui.getCore().byId("idNameInput")
								.getValue();
						var oInputPassword = sap.ui.getCore().byId(
								"idPasswordInput").getValue();

						if (oInputName === "" || oInputPassword === ""
								|| oInputName === undefined
								|| oInputPassword === undefined) {
							sap.m.MessageToast
									.show("Please enter username and/or password!");
						}
						...
						$.ajax({
								...
								error : function(xhr, readyState) {
									...
									var oUserName = sap.ui.getCore().byId(
											"idNameInput");
									oUserName.setValue();
									var oUserPwd = sap.ui.getCore().byId(
											"idPasswordInput");
									oUserPwd.setValue();
									console.log(xhr);
									console.log("ERROR: " + readyState);
